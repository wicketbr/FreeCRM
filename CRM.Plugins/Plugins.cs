namespace Plugins
{
    ...
    public class Plugins : IPlugins
    {
        private byte[] _key = new byte[] {
            0xC6, 0x46, 0xB1, 0xA0, 0x62, 0x0C, 0xCF, 0x29, 
            0xE4, 0xBE, 0x04, 0x38, 0x0F, 0xB8, 0x64, 0xFE, 
            0xA8, 0x25, 0xF8, 0x54, 0x46, 0x5D, 0xA0, 0xDF, 
            0x2E, 0xB3, 0x1D, 0xE9, 0x6E, 0xF3, 0xF5, 0xAE 
        };
